...
Run against `plugin/` (embedded vector store) — 2026-03-07.
...
| **Integration** | Real vector store + real embedder against a test store | ~30s |
| **E2E** | Real `opencode` processes, real memory store, 13 autonomous scenarios | ~5–10 min |
