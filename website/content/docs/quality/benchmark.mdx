...
DevMemBench is an independent benchmark that measures how reliably codexfi recalls facts across coding sessions. The latest run scores **94.5% overall** — 189 correct answers out of 200 questions — across 8 categories that map directly to how you use memory day-to-day.
