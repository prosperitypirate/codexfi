...
After every assistant turn, codexfi analyzes the conversation and extracts key facts as typed memories. Each memory is embedded with [Voyage AI](https://www.voyageai.com/) (`voyage-code-3`) and stored locally in a SQLite database on your machine — no external dependencies, multi-agent safe.
