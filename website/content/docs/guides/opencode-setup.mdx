...
in the background. It uses a local SQLite database + Voyage AI embeddings,
...
- Memory data is stored at `~/.codexfi/store/store.db` — the store is yours to inspect or delete
